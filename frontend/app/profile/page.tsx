        ...
        <div className="bg-background text-on-background min-h-screen flex flex-col font-body-sm">
            <main className="flex-grow w-full px-margin py-xl max-w-7xl mx-auto">
                ...
                <section className="grid grid-cols-1 md:grid-cols-12 gap-gutter mb-xl items-end">
                    <div className="md:col-span-8">
                        <span className="font-label-caps text-label-caps text-on-surface-variant block mb-sm">ATHLETE WALLET ADDRESS</span>
                        <h1 className="font-data-lg text-data-lg break-all">{walletAddress ?? '—'}</h1>
                    </div>
                    <div className="md:col-span-4 md:text-right">
                        <span className="font-label-caps text-label-caps text-on-surface-variant block mb-sm">WALLET BALANCE</span>
                        <div className="font-headline-lg text-headline-lg">{usdcBalance.toFixed(2)} <span className="text-on-surface-variant text-[24px]">USDC</span></div>
                        <div className="font-label-caps text-label-caps text-on-surface-variant mt-xs">{solBalance.toFixed(3)} SOL</div>
                    </div>
                </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
                    ...
                    <div className="md:col-span-4 flex flex-col gap-gutter">
                        ...
                        {/* Connected Devices (Template) */}
                        <div className="border-2 border-primary p-lg">
                            <div className="flex items-center justify-between mb-lg">
                                <h2 className="font-label-caps text-label-caps">CONNECTED DEVICES</h2>
                                <span className="bg-primary text-on-primary px-xs py-1 font-label-caps text-[10px]">TEMPLATE</span>
                            </div>
                        ...
                        <div className="border-2 border-primary p-lg bg-primary text-on-primary">
                            <h2 className="font-label-caps text-label-caps mb-md">PENDING REWARDS</h2>
                            <div className="font-headline-md text-headline-md mb-lg">— USDC</div>
                            <button
                                disabled
                    ...
                    <div className="md:col-span-8">
                        <div className="border-2 border-primary p-lg h-full">
                            <div className="flex items-center justify-between mb-xl">
                                <h2 className="font-label-caps text-label-caps">RACE HISTORY</h2>
                                <span className="font-label-caps text-label-caps text-on-surface-variant">TOTAL RACES: —</span>
                            </div>
            ...
            <footer className="flex flex-col md:flex-row justify-between items-center w-full px-margin py-lg gap-gutter border-t-2 border-primary bg-background">
                ...
                <div className="flex flex-col items-center gap-sm">
                    <div className="font-label-caps text-label-caps text-on-surface-variant">© 2026 SOLARUN PROTOCOL // ALL PERFORMANCE DATA ON-CHAIN</div>
