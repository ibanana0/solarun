...
export function useStakingAndFees(program: any) {
     ...
     */
    const executeStakeEvent = useCallback(async (
        eventId: string,
        ...
        try {
            ...
            const txSignature = await program.methods
                .stake_event(eventId, stakeAmountTokens)
                .accounts({
            ...
            const message = error instanceof Error ? error.message : 'Unknown error during staking';
